...
public class Communicationl implements Communication {
    ...
    public Communicationl(int type) {
        this.type = type;
    }
    ...
    public Communicationl(int type, ArrayList<Storage> storageList ) {
        this.type = type;
    ...
    public Communicationl(int type, ArrayList<Orders> ordersArrayList, double fake){
        this.type = type;
...
///////////
    public Communicationl(int type, ArrayList<User> userList, int fake) {
        super();
